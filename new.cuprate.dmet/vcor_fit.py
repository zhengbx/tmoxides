...
from helpers import mdot, to_triangle
import numpy as np
...
def FitVcorComponent(EmbFock, nImp, RdmHl, VLOC_TYPE, VLOC_FIT_TYPE):
   ...
   #if 0:
   if VLOC_TYPE == "Local" and VLOC_FIT_TYPE in ["AnalyticalImpRdm", "AnalyticalFullRdm"]:
      ...
      return GetImpRdmFitAnalytical(RdmHl, nImp, VLOC_TYPE, VLOC_FIT_TYPE[10:])
   else:
      ...
      def Err1v(vloc):
         ...
         if VLOC_FIT_TYPE == "FullRdm":
            ...
            # fit only non redundant elements
