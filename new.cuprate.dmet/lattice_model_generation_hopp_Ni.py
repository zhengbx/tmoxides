...
class FLatticeModel(object):
   ...
   def MakeTijMatrix(self, SitesR, SitesC):
      ...
      import re
      f = open('rham_LaNiCO3_sort.py','r')
      f2 = open('hoppingNi.py', 'a')
      for line in f:
         data = re.split(',|\n', line)
         XyzI = np.array([int(data[0]), int(data[1]), int(data[2])])
         XyzJ = np.array([ 0, 0, 0]) 
         if (whichorb[int(data[3])](XyzI)[0]!='Ni3' and whichorb[int(data[4])](XyzJ)[0]!='Ni3'):
...
class FHubbardModel_La2CuO4(FLatticeModel):
   ...
   def __init__(self, t, U, J, Delta):
      UnitCell = []
      #fractional coords
      UnitCell.append( ("Cu1", np.array([0,  0,  0])) ) #1d-orbital d_x2y2 
      UnitCell.append( ("Cu2", np.array([0,  0,  0])) ) #1d-orbital d_z2 
      ...
      UnitCell.append( ("Oz", np.array([0.5,  0,  0.5])) ) #p-orbital
      UnitCell.append( ("Ox", np.array([0.5,  0,  0.5])) ) #p-orbital
      UnitCell.append( ("Oy", np.array([0.5,  0,  0.5])) ) #p-orbital
      
      UnitCell.append( ("Oz", np.array([0,  0.5,  0.5])) ) #p-orbital
      UnitCell.append( ("Ox", np.array([0,  0.5,  0.5])) ) #p-orbital
      UnitCell.append( ("Oy", np.array([0,  0.5,  0.5])) ) #p-orbital
      
      UnitCell.append( ("Cu1", np.array([ 0.5,   0.5,  0.5])) ) #1d-orbital d_x2y2
      UnitCell.append( ("Cu2", np.array([ 0.5,   0.5,  0.5])) ) #1d-orbital d_z2
      UnitCell.append( ("Oz", np.array([0,  0, 0.1858])) ) #p-orbital
      UnitCell.append( ("Ox", np.array([0,  0, 0.1858])) ) #p-orbital
      UnitCell.append( ("Oy", np.array([0,  0, 0.1858])) ) #p-orbital
      
      UnitCell.append( ("Oz", np.array([0,  0, 0.8142]))  )#p-orbital
      UnitCell.append( ("Ox", np.array([0,  0, 0.8142]))  )#p-orbital
      UnitCell.append( ("Oy", np.array([0,  0, 0.8142]))  )#p-orbital
      
      UnitCell.append( ("Oz", np.array([0.5,  0.5, 0.6858])) ) #p-orbital
      UnitCell.append( ("Ox", np.array([0.5,  0.5, 0.6858])) ) #p-orbital
      UnitCell.append( ("Oy", np.array([0.5,  0.5, 0.6858])) ) #p-orbital
      
      UnitCell.append( ("Oz", np.array([0.5,  0.5, 0.3142])) ) #p-orbital
      UnitCell.append( ("Ox", np.array([0.5,  0.5, 0.3142])) ) #p-orbital
      UnitCell.append( ("Oy", np.array([0.5,  0.5, 0.3142])) ) #p-orbital
