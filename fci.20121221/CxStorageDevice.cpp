...
void FStorageDevicePosixFs::Write( FRecord const &r, void const *pData, FOffset nLength, FOffset Offset ) const
{
...
void FStorageDevicePosixFs::Read( FRecord const &r, void *pData, FOffset nLength, FOffset Offset ) const
{
    FILE *File = GetHandle(r);
    fseek(File, Offset + r.BaseOffset, SEEK_SET);
...
void FStorageDevicePosixFs::Reserve( FRecord const &r, FOffset nLength ) const
{
};
...
void FStorageDevice::FRecord::SetLength(FOffset NewLength) const
{
...
void FStorageDeviceMemoryBuf::Write( FRecord const &r, void const *pData, FOffset nLength, FOffset Offset ) const
{
...
void FStorageDeviceMemoryBuf::Read( FRecord const &r, void *pData, FOffset nLength, FOffset Offset ) const
{
    FBuffer &Buf = GetBuf(r);
    Offset += r.BaseOffset;
    assert(Offset + nLength <= Buf.Length );
...
void FStorageDeviceMemoryBuf::Reserve( FRecord const &r, FOffset nLength ) const
{
    FBuffer &Buf = GetBuf(r);
    delete Buf.p;
...
void FStorageDeviceMemoryBuf::Delete( FRecord const &r ) const
{
    FBuffer &Buf = GetBuf(r);
    delete Buf.p;
    Buf.p = 0;
